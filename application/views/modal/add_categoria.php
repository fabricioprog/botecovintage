<div id="<?= $id ?>" >
    <form method="POST" hidden enctype="multipart/form-data" name='teste'>
        ...
        <div class="form-group">
            <label for="exampleInputFile" class="bmd-label-floating">Imagem</label>
            <input type="file" class="form-control-file" name="imagem" id="upload_imagem">
            <small class="text-muted"> Adicione uma imagem
        </div>
